...
import shopbanhang.Service.User.BillsServiceImpl;
import shopbanhang.Service.User.CartServiceImpl;
...
public class CartController extends BaseController {
	...
	@RequestMapping(value = { "chi-tiet-san-pham/gio-hang", "gio-hang" })
	...
	public String AddCart(HttpServletRequest request, HttpSession session, @PathVariable long id) { // lưu sản phẩm
																									// trong giỏ hàng
																									// vào session
