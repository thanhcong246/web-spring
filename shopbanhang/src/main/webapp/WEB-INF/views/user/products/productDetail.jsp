			...
			<div class="well well-small">
				<ul class="nav nav-list">
					<li><a href="products.html"><i
							class="fa-solid fa-hand-point-right" style="margin-right: 4px"></i>Fashion</a></li>
				...
				<div class="row-fluid">
						...
						<div id="myCarousel" class="carousel slide cntr">
							<div class="carousel-inner">
								<div class="item active">
									<a href="#"> <img
										src="<c:url value="/assets/user/img/${productDetail.img }" />"
					...
					<div class="span7">
						...
						<form class="form-horizontal qtyFrm" method="get"
							action='<c:url value="/AddCart/${productDetail.id_product }" />'>
							<div class="control-group">
								<label class="control-label"><span><fmt:formatNumber
											type="number" groupingUsed="true" value="${productDetail.price }" />₫
								</span></label>
								<div class="controls">
